...
`scripts/can/isotp-c-mcu-check.sh` builds `isotp.c` for a bare-metal Cortex-M4
and fails if an allocator appears. What the object actually needs from outside:
