...
z_result_t _z_endpoint_ivc_valid(_z_endpoint_t *ep);
z_result_t _z_new_link_ivc(_z_link_t *zl, _z_endpoint_t ep);
#endif
...
// nros: Phase 115.B
z_result_t _z_endpoint_custom_valid(_z_endpoint_t *ep);
z_result_t _z_new_link_custom(_z_link_t *zl, _z_endpoint_t ep);
#endif
